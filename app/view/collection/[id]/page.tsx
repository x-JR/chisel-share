      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 mb-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <div className="shrink-0 flex flex-col gap-2">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-slate-700 hover:bg-slate-600 text-slate-200 text-sm font-medium px-4 py-2 rounded-lg border border-slate-600 transition-colors"
          >
            ⬇ Download All
          </a>
          <div className="w-40">
